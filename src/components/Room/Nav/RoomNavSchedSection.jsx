...
const RoomNavSchedSection = () => {
  ...
  const outTimeString = selectedSchedule.outTime !== null ? TIME_SLOTS_30_MIN[selectedSchedule.outTime + 1] : ""

  return (
    <div className="flex flex-col gap-4">
      <div>
        <h2 className="font-semibold uppercase text-sm text-black-text my-2">Select your Schedules Date & Time</h2>
      ...
      <div className="flex gap-4">
        ...
        <div className="flex gap-1 flex-1 text-sm relative text-black-text px-4 rounded-lg py-3 border border-gray-500 w-fit">
          <h2>{startingTimeString || "00:00"}</h2>
          <span>-</span>
          <h2>{outTimeString || "00:00"}</h2>
