const NorthCongressModel = ({style}) => {
  return (
    ...
    <svg className="fill-[#008236] absolute  w-full h-full top-0 ">
      ...
      <rect width="100%" height="100%" className="opacity-20 hover:opacity-50 z-20" clipPath="url(#clipPath2)" />
      <rect width="100%" height="100%" className="opacity-20 hover:opacity-50 z-20" clipPath="url(#clipPath1)" />
    </svg>

    <h1 className="absolute w-full bottom-10 font-bold text-lg text-center">UCC NORTH - CONGRESSIONAL CAMPUS</h1>
