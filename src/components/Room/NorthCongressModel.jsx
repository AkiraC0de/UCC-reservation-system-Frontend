  ...
  return (
    <div className={style}>
      ...
      <svg className="fill-[#008236] absolute  w-full h-full top-0">
        ...
        <rect onClick={() => handleBuilding("Right Wing")} onMouseEnter={handleRightWingHovered} onMouseLeave={handleRightWingHovered} width="100%" height="100%" className="cursor-pointer opacity-0 hover:opacity-50 z-20" clipPath="url(#clipPath2)" />
        <rect onClick={() => handleBuilding("Left Wing")} onMouseEnter={handleLeftWingHovered} onMouseLeave={handleLeftWingHovered} width="100%" height="100%" className="cursor-pointer opacity-0 hover:opacity-50 z-20 " clipPath="url(#clipPath1)" />
      </svg>
