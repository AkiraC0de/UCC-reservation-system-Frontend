...
const Select = ({ 
  ...
  return (
    ...
    >
      ...
      <button
        onClick={handleClick}
        className={`flex items-center ${shrink ? "justify-center" : "justify-between px-1.5"} transition-all duration-500 py-0.5 rounded-2xl  cursor-pointer`}
      >
        {<Icon className={`${isRequired ? "fill-red-600" : "fill-black/40"} w-8`}/>}
