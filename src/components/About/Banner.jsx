    ...
    return (
      <div className="w-full grid-rows-[auto] bg-white rounded-lg overflow-hidden flex shadow-md">
        <div className="flex-2 flex flex-col p-9 space-y-5 h-full text-[#303135] relative pr-15">
          <h1 className=" text-5xl font-bold text-green-700">About the MIS Room and Equipment Reservation System</h1>
          <h2 className="text-lg font-medium">Get to know MRERS — its vision, mission, and the developers behind this innovative project.</h2>
          <svg 
